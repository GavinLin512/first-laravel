                    ...
                    <div class="tab-pane fade active show px-2" id="custom-content-above-home" role="tabpanel"
                        ...
                        <div class="form-group row mb-3">
                            <div class="col-6 d-flex align-content-center">
                                <label for="country" class="mb-0 d-flex align-items-center col-2">*國別</label>
                            ...
                            <div class="col-6 d-flex align-content-center">
                                <label for="taxID" class="mb-0 d-flex align-items-center col-2">統一編號</label>
                                <input type="number" class="form-control col-10" id="taxID" placeholder="請填寫正確企業編號"
                        ...
                        <div class="form-group row mb-3">
                            <div class="col-6 d-flex align-content-center">
                                <label for="chi_name" class="mb-0 d-flex align-items-center col-2">*中文名稱</label>
                                <input type="text" class="form-control col-10" id="chi_name" placeholder="請填寫正確企業名稱">
                            </div>
                            <div class="col-6 d-flex align-content-center">
                                <label for="eng_name" class="mb-0 d-flex align-items-center col-2">英文名稱</label>
                                <input type="text" class="form-control col-10" id="eng_name" placeholder="請填寫正確企業名稱">
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-3 px-2">
                            ...
                            <input type="text" class="form-control col-11" id="address" placeholder="請填寫正確地址">
                        </div>
                        ...
                        <div class="form-group row mb-3 px-2">
                            ...
                            <input type="number" class="form-control col-11" id="phone" placeholder="請填寫有效電話">
                        </div>

                        <div class="form-group row mb-5">
                            <div class="col-6 d-flex">
                                <label for="exampleInputFile" class="m-0 d-flex align-items-center col-2">附件</label>
                            ...
                            <div class="col-6 d-flex align-content-center">
                                <p class="mb-0 d-flex align-items-center">(檔案以jpg/gif/pdf為主，不超過10mb)</p>
                            </div>
                        </div>
                        {{-- 作業方式 --}}
                        <p class="lead border-bottom mt-5">作業方式</p>
                        <div class="form-group row mb-3">
                            <label class="mb-0 d-flex col-1">*作業速度</label>
                        ...
                        <div class="form-group row mb-3">
                            <label class="mb-0 d-flex col-1">*保密程度</label>
                        ...
                        <div class="form-group row mb-3">
                            <label for="invest" class="mb-0 col-1">調查重點</label>
                            <textarea class="form-control mx-2" id="address" name="invest" rows="2"
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-11 d-flex ">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label mr-5">中文(預設)</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox">
                                    <label class="form-check-label mr-5">英文</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox">
                                    <label class="form-check-label">日文</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-10 d-flex ">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" checked="checked">
                                    <label class="form-check-label mr-5">公司</label>
                                </div>
                                <div class="form-check col-4">
                                    <input class="form-check-input" type="checkbox">
                                    <label class="form-check-label mr-5 d-flex">
                        ...
                        <button class="btn btn-primary mt-5 upload">加入並繼續委託</button>
                    </div>
